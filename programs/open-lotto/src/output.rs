...
use anchor_lang::solana_program::{system_instruction, hash};
use std::convert::TryInto;
/// The static program ID
pub static ID: anchor_lang::solana_program::pubkey::Pubkey = anchor_lang::solana_program::pubkey::Pubkey::new_from_array([
    138u8, 222u8, 195u8, 200u8, 249u8, 32u8, 109u8, 228u8, 253u8, 206u8, 54u8, 238u8,
    139u8, 29u8, 21u8, 1u8, 110u8, 152u8, 208u8, 234u8, 221u8, 199u8, 139u8, 229u8, 16u8,
    142u8, 195u8, 216u8, 224u8, 128u8, 1u8, 207u8,
]);
/// Const version of `ID`
...
pub mod program {
    ...
    pub struct OpenLotto;
    #[automatically_derived]
    impl ::core::clone::Clone for OpenLotto {
        #[inline]
        fn clone(&self) -> OpenLotto {
            OpenLotto
        }
    }
    impl anchor_lang::Id for OpenLotto {
        fn id() -> Pubkey {
            ID
        }
    }
...
fn dispatch<'info>(
    ...
    if data.starts_with(instruction::CreatePot::DISCRIMINATOR) {
        return __private::__global::create_pot(
            program_id,
            accounts,
            &data[instruction::CreatePot::DISCRIMINATOR.len()..],
        );
    }
...
mod __private {
                        ...
                        anchor_lang::error::Error::from(anchor_lang::error::AnchorError {
                                ...
                                error_origin: Some(
                                    anchor_lang::error::ErrorOrigin::Source(anchor_lang::error::Source {
                                        filename: "programs/open-lotto/src/lib.rs",
                                        line: 7u32,
                                    }),
                                ),
    ...
    pub mod __global {
        use super::*;
        #[inline(never)]
        pub fn create_pot<'info>(
            __program_id: &Pubkey,
            __accounts: &'info [AccountInfo<'info>],
            __ix_data: &[u8],
        ) -> anchor_lang::Result<()> {
            ::solana_msg::sol_log("Instruction: CreatePot");
            let ix = instruction::CreatePot::deserialize(&mut &__ix_data[..])
                .map_err(|_| {
                    anchor_lang::error::ErrorCode::InstructionDidNotDeserialize
                })?;
            let instruction::CreatePot { day } = ix;
            let mut __bumps = <CreatePot as anchor_lang::Bumps>::Bumps::default();
            let mut __reallocs = std::collections::BTreeSet::new();
            let mut __remaining_accounts: &[AccountInfo] = __accounts;
            let mut __accounts = CreatePot::try_accounts(
                __program_id,
            ...
            let result = open_lotto::create_pot(
...
pub mod open_lotto {
    use super::*;
    pub fn create_pot(ctx: Context<CreatePot>, day: u64) -> Result<()> {
        let pot = &mut ctx.accounts.pot;
        pot.day = day;
        pot.authority = *ctx.accounts.authority.key;
        pot.participant_count = 0;
        pot.winner = None;
        pot.last_random_number = 0;
        Ok(())
    }
}
...
pub mod instruction {
    use super::*;
    /// Instruction.
    pub struct CreatePot {
        pub day: u64,
    }
    impl borsh::ser::BorshSerialize for CreatePot
    where
        u64: borsh::ser::BorshSerialize,
    {
        fn serialize<W: borsh::maybestd::io::Write>(
            ...
            borsh::BorshSerialize::serialize(&self.day, writer)?;
            Ok(())
        }
    }
    impl borsh::de::BorshDeserialize for CreatePot
    where
        u64: borsh::BorshDeserialize,
    {
        fn deserialize_reader<R: borsh::maybestd::io::Read>(
            ...
            Ok(Self {
                day: borsh::BorshDeserialize::deserialize_reader(reader)?,
            })
        }
    }
    impl anchor_lang::Discriminator for CreatePot {
        const DISCRIMINATOR: &'static [u8] = &[232, 45, 123, 181, 204, 121, 131, 9];
    }
    impl anchor_lang::InstructionData for CreatePot {}
    impl anchor_lang::Owner for CreatePot {
        fn owner() -> Pubkey {
            ID
        }
    }
...
pub mod accounts {
    pub use crate::__client_accounts_create_pot::*;
}
#[instruction(day:u64)]
...
#[automatically_derived]
impl<'info> anchor_lang::Accounts<'info, CreatePotBumps> for CreatePot<'info>
where
    'info: 'info,
{
    #[inline(never)]
    fn try_accounts(
        ...
        let __Args { day } = __Args::deserialize(&mut __ix_data)
            .map_err(|_| anchor_lang::error::ErrorCode::InstructionDidNotDeserialize)?;
        if __accounts.is_empty() {
            return Err(anchor_lang::error::ErrorCode::AccountNotEnoughKeys.into());
        }
        let pot = &__accounts[0];
        *__accounts = &__accounts[1..];
        let authority: Signer = anchor_lang::Accounts::try_accounts(
                __program_id,
                __accounts,
        ...
        let __anchor_rent = Rent::get()?;
        let (__pda_address, __bump) = Pubkey::find_program_address(
            &[b"lottery", &day.to_le_bytes()[..], authority.key().as_ref()],
            __program_id,
        );
        __bumps.pot = __bump;
        if pot.key() != __pda_address {
            return Err(
                anchor_lang::error::Error::from(
                        anchor_lang::error::ErrorCode::ConstraintSeeds,
                    )
                    .with_account_name("pot")
                    .with_pubkeys((pot.key(), __pda_address)),
            );
        }
        let pot = ({
            #[inline(never)]
            || {
                let actual_field = AsRef::<AccountInfo>::as_ref(&pot);
                let actual_owner = actual_field.owner;
                let space = Pot::space();
                let pa: anchor_lang::accounts::account::Account<Pot> = if !false
                    || actual_owner == &anchor_lang::solana_program::system_program::ID
                {
                    let __current_lamports = pot.lamports();
                    if __current_lamports == 0 {
                        ...
                        if authority.key() == pot.key() {
                            return Err(
                                anchor_lang::error::Error::from(anchor_lang::error::AnchorError {
                                    ...
                                    .with_pubkeys((authority.key(), pot.key())),
                            );
                        }
                        ...
                        let cpi_accounts = anchor_lang::system_program::Allocate {
                            account_to_allocate: pot.to_account_info(),
                        };
                        let cpi_context = anchor_lang::context::CpiContext::new(
                            system_program.to_account_info(),
                            cpi_accounts,
                        ...
                        let cpi_accounts = anchor_lang::system_program::Assign {
                            account_to_assign: pot.to_account_info(),
                        };
                        let cpi_context = anchor_lang::context::CpiContext::new(
                            system_program.to_account_info(),
                            cpi_accounts,
                    ...
                    match anchor_lang::accounts::account::Account::try_from_unchecked(
                        ...
                        Ok(val) => val,
                        Err(e) => return Err(e.with_account_name("pot")),
                    }
                } else {
                    match anchor_lang::accounts::account::Account::try_from(&pot) {
                        Ok(val) => val,
                        Err(e) => return Err(e.with_account_name("pot")),
                    }
                };
        ...
        if !AsRef::<AccountInfo>::as_ref(&pot).is_writable {
            return Err(
                anchor_lang::error::Error::from(
                        anchor_lang::error::ErrorCode::ConstraintMut,
                    )
        ...
        if !__anchor_rent
            .is_exempt(
                pot.to_account_info().lamports(),
                pot.to_account_info().try_data_len()?,
            )
        {
            return Err(
                anchor_lang::error::Error::from(
...
#[automatically_derived]
impl<'info> anchor_lang::ToAccountInfos<'info> for CreatePot<'info>
where
    'info: 'info,
{
    fn to_account_infos(
        ...
        let mut account_infos = ::alloc::vec::Vec::new();
        account_infos.extend(self.pot.to_account_infos());
        account_infos.extend(self.authority.to_account_infos());
        account_infos.extend(self.system_program.to_account_infos());
        account_infos
    }
...
#[automatically_derived]
impl<'info> anchor_lang::ToAccountMetas for CreatePot<'info> {
    fn to_account_metas(
        &self,
        is_signer: Option<bool>,
    ) -> Vec<anchor_lang::solana_program::instruction::AccountMeta> {
        let mut account_metas = ::alloc::vec::Vec::new();
        account_metas.extend(self.pot.to_account_metas(None));
        account_metas.extend(self.authority.to_account_metas(None));
        account_metas.extend(self.system_program.to_account_metas(None));
        account_metas
    }
...
#[automatically_derived]
impl<'info> anchor_lang::AccountsExit<'info> for CreatePot<'info>
where
    'info: 'info,
{
    fn exit(
        ...
        anchor_lang::AccountsExit::exit(&self.pot, program_id)
            .map_err(|e| e.with_account_name("pot"))?;
        anchor_lang::AccountsExit::exit(&self.authority, program_id)
            .map_err(|e| e.with_account_name("authority"))?;
        Ok(())
    }
}
pub struct CreatePotBumps {
    pub pot: u8,
}
#[automatically_derived]
impl ::core::fmt::Debug for CreatePotBumps {
    #[inline]
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        ::core::fmt::Formatter::debug_struct_field1_finish(
            f,
...
impl Default for CreatePotBumps {
    fn default() -> Self {
        CreatePotBumps { pot: u8::MAX }
    }
}
impl<'info> anchor_lang::Bumps for CreatePot<'info>
where
    'info: 'info,
{
    type Bumps = CreatePotBumps;
}
/// An internal, Anchor generated module. This is used (as an
/// implementation detail), to generate a struct for a given
/// `#[derive(Accounts)]` implementation, where each field is a Pubkey,
...
/// To access the struct in this module, one should use the sibling
/// `accounts` module (also generated), which re-exports this.
pub(crate) mod __client_accounts_create_pot {
    use super::*;
    use anchor_lang::prelude::borsh;
    /// Generated client accounts for [`CreatePot`].
    pub struct CreatePot {
        pub pot: Pubkey,
        pub authority: Pubkey,
        pub system_program: Pubkey,
        ...
        Pubkey: borsh::ser::BorshSerialize,
    {
        fn serialize<W: borsh::maybestd::io::Write>(
            ...
            borsh::BorshSerialize::serialize(&self.pot, writer)?;
            borsh::BorshSerialize::serialize(&self.authority, writer)?;
            borsh::BorshSerialize::serialize(&self.system_program, writer)?;
            Ok(())
        }
    ...
    #[automatically_derived]
    impl anchor_lang::ToAccountMetas for CreatePot {
        fn to_account_metas(
            &self,
            is_signer: Option<bool>,
        ) -> Vec<anchor_lang::solana_program::instruction::AccountMeta> {
...
/// To access the struct in this module, one should use the sibling
/// [`cpi::accounts`] module (also generated), which re-exports this.
pub(crate) mod __cpi_client_accounts_create_pot {
    use super::*;
    /// Generated CPI struct of the accounts for [`CreatePot`].
    pub struct CreatePot<'info> {
        pub pot: anchor_lang::solana_program::account_info::AccountInfo<'info>,
    ...
    impl<'info> anchor_lang::ToAccountInfos<'info> for CreatePot<'info> {
        fn to_account_infos(
            ...
            let mut account_infos = ::alloc::vec::Vec::new();
            account_infos
                .extend(anchor_lang::ToAccountInfos::to_account_infos(&self.pot));
            account_infos
                .extend(anchor_lang::ToAccountInfos::to_account_infos(&self.authority));
            account_infos
                .extend(
...
impl borsh::ser::BorshSerialize for Pot
where
    u64: borsh::ser::BorshSerialize,
    Pubkey: borsh::ser::BorshSerialize,
    u64: borsh::ser::BorshSerialize,
    ...
    u64: borsh::ser::BorshSerialize,
{
    fn serialize<W: borsh::maybestd::io::Write>(
        ...
        borsh::BorshSerialize::serialize(&self.day, writer)?;
        borsh::BorshSerialize::serialize(&self.authority, writer)?;
        borsh::BorshSerialize::serialize(&self.participant_count, writer)?;
        borsh::BorshSerialize::serialize(&self.winner, writer)?;
        borsh::BorshSerialize::serialize(&self.last_random_number, writer)?;
        Ok(())
    }
}
impl borsh::de::BorshDeserialize for Pot
where
    u64: borsh::BorshDeserialize,
    Pubkey: borsh::BorshDeserialize,
    u64: borsh::BorshDeserialize,
    ...
    u64: borsh::BorshDeserialize,
{
    fn deserialize_reader<R: borsh::maybestd::io::Read>(
        ...
        Ok(Self {
            day: borsh::BorshDeserialize::deserialize_reader(reader)?,
            authority: borsh::BorshDeserialize::deserialize_reader(reader)?,
            participant_count: borsh::BorshDeserialize::deserialize_reader(reader)?,
            winner: borsh::BorshDeserialize::deserialize_reader(reader)?,
            last_random_number: borsh::BorshDeserialize::deserialize_reader(reader)?,
        })
    }
}
#[automatically_derived]
impl ::core::clone::Clone for Pot {
    #[inline]
    fn clone(&self) -> Pot {
        Pot {
            ...
            winner: ::core::clone::Clone::clone(&self.winner),
            last_random_number: ::core::clone::Clone::clone(&self.last_random_number),
        }
    }
}
#[automatically_derived]
impl anchor_lang::AccountSerialize for Pot {
    fn try_serialize<W: std::io::Write>(
        &self,
        writer: &mut W,
    ) -> anchor_lang::Result<()> {
        if writer.write_all(Pot::DISCRIMINATOR).is_err() {
...
#[automatically_derived]
impl anchor_lang::AccountDeserialize for Pot {
    fn try_deserialize(buf: &mut &[u8]) -> anchor_lang::Result<Self> {
        if buf.len() < Pot::DISCRIMINATOR.len() {
            return Err(
                anchor_lang::error::ErrorCode::AccountDiscriminatorNotFound.into(),
            );
        }
        let given_disc = &buf[..Pot::DISCRIMINATOR.len()];
        if Pot::DISCRIMINATOR != given_disc {
            return Err(
                anchor_lang::error::Error::from(anchor_lang::error::AnchorError {
                        error_name: anchor_lang::error::ErrorCode::AccountDiscriminatorMismatch
                            .name(),
    ...
    fn try_deserialize_unchecked(buf: &mut &[u8]) -> anchor_lang::Result<Self> {
        let mut data: &[u8] = &buf[Pot::DISCRIMINATOR.len()..];
        AnchorDeserialize::deserialize(&mut data)
            .map_err(|_| anchor_lang::error::ErrorCode::AccountDidNotDeserialize.into())
    }
}
#[automatically_derived]
impl anchor_lang::Discriminator for Pot {
    const DISCRIMINATOR: &'static [u8] = &[238, 118, 60, 175, 178, 191, 59, 58];
}
#[automatically_derived]
impl anchor_lang::Owner for Pot {
    fn owner() -> Pubkey {
        crate::ID
    }
}
